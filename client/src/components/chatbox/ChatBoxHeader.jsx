...
import { removeChat } from '../../redux/chat/chatSlice';
    ...
    return (
        <div className='flex justify-between items-center py-4 px-4 border-b border-pink-400 shadow-sm'>
            <div className='flex items-center gap-2'>
                <div onClick={() => dispatch(removeChat())} className='md:hidden rotate-180 flex justify-center items-center  hover:bg-pink-100 h-8 w-8 rounded-full '>
